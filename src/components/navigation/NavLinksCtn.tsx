...
const NavLinksCtn: FC<Props> = ({
  ...
  return (
    <ul
      ...
      } ul--clamp bg-purple-300 font-medium text-gray-700 dark:bg-slate-500 dark:text-slate-200 md:relative md:top-auto md:left-auto md:flex md:h-auto md:w-auto md:translate-x-0 md:flex-row md:gap-10 md:bg-transparent md:p-0 md:dark:bg-transparent`}
    >
